...
export class DispositionEigenfertigungService {
    ...
    plan(dispositionInput: DispositionEigenfertigungArticleInput): Observable<DispositionEigenfertigungArticleInput> {
        return this.httpClient
            .post<DispositionEigenfertigungArticleInput>(this.#baseUrl, dispositionInput, {})
    }
